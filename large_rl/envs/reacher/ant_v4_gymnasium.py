...
from large_rl.envs.reacher import mujoco_env_gymnasium as mujoco_env
...
class AntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        mujoco_env.MujocoEnv.__init__(self, model_path=xml_file, frame_skip=5, action_type=action_type,
                                      bijective_dims=bijective_dims,
                                      validity_type=validity_type,
                                      validity_box_size=validity_box_size,
                                      **kwargs)
    ...
    def _get_obs(self):
        ...
        if self._use_contact_forces:
            ...
            ob = np.concatenate((position, velocity, contact_force))
        else:
            ob = np.concatenate((position, velocity))
