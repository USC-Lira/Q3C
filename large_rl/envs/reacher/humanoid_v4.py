...
class HumanoidEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        # )
        mujoco_env.MujocoEnv.__init__(self, model_path="humanoid.xml", frame_skip=5, action_type=action_type,
                                      bijective_dims=bijective_dims, validity_type=validity_type, **kwargs)
