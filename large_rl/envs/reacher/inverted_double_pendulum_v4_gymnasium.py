...
class InvertedDoublePendulumEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self,
        ...
        mujoco_env.MujocoEnv.__init__(self, model_path="inverted_double_pendulum.xml", frame_skip=5,
    ...
    def step(self, action):
        ...
        if not if_valid:
            r = -10
        return ob, r, terminated, False, {"if_valid": if_valid}
