...
class HalfCheetahEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        # )
        mujoco_env.MujocoEnv.__init__(self, model_path="half_cheetah.xml", frame_skip=5, action_type=action_type,
    ...
    def _get_obs(self):
        ...
        ob = np.concatenate((position, velocity)).ravel()
